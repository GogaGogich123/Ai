...
public final class PrintCommand {
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.m_82127_((String)"3dprint").requires(source -> source.m_6761_(4))).executes(source -> PrintCommand.upload((CommandSourceStack)source.getSource(), ""))).then(Commands.m_82129_((String)"name", (ArgumentType)MessageArgument.m_96832_()).executes(source -> PrintCommand.upload((CommandSourceStack)source.getSource(), MessageArgument.m_96835_((CommandContext)source, (String)"name").getString()))));
    }
